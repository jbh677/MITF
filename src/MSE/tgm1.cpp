...
// MP version so no summary output just harvest rates
...
Type objective_function<Type>::operator() ()
{
  ...
  for(r1=0;r1<nrelev;r1++) {
    ...
    for(r2=0;r2<nrecev(r1);r2++) nll -= R(r1,r2+2)*log(pr(r2)+1e-8);
