...
Type objective_function<Type>::operator() ()
{
  ...
  DATA_SCALAR(sigmah); // prior variance of logit harvest rates
  ...
  array<Type> Rhat(nrelev,nrecmax,nr);  
  array<Type> prhat(nrelev,nrecmax,nr);
  ...
  for(t=0;t<nrelev;t++) {
      ...
      for(t2=0;t2<nrecev(t);t2++) {
        for(r=0;r<nr;r++) {
          ...
          Rhat(t,t2,r) = T(t)*pr(t2,r);
          prhat(t,t2,r) = pr(t2,r);
          nll -= R(t,t2,r)*log(pr(t2,r)+1e-8);
