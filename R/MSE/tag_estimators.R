...
ggplot(midf)+geom_point(aes(x=yrec,y=x),colour='brown')+geom_point(aes(x=yrec,y=xhat),colour='dark green')+facet_wrap(~yrel)+theme_bw()+xlab("Year of recapture")+ylab("Recaptures")
...
ggplot(tmp1)+geom_point(aes(x=recyr,y=x),colour='brown')+geom_point(aes(x=recyr,y=xhat),colour='dark green')+facet_wrap(~yrel)+theme_bw()+xlab("Year of recapture")+ylab("Recaptures")
...
ggplot(tmp1)+geom_point(aes(x=yrel,y=x),colour='brown')+geom_point(aes(x=yrel,y=xhat),colour='dark green')+facet_wrap(~recr)+theme_bw()+xlab("Year of release")+ylab("Recaptures")

# aggregated across release region and release year

tmp1 <- aggregate(tsdf$x,by=list(yrel=tsdf$recyr,recr=tsdf$recr),FUN=sum)
tmp2 <- aggregate(tsdf$xhat,by=list(yrel=tsdf$recyr,recr=tsdf$recr),FUN=sum)
tmp1 <- cbind(tmp1,tmp2$x)
names(tmp1)[[4]] <- "xhat"

ggplot(tmp1)+geom_point(aes(x=yrel,y=x),colour='brown')+geom_point(aes(x=yrel,y=xhat),colour='dark green')+facet_wrap(~recr)+theme_bw()+xlab("Year of recapture")+ylab("Recaptures")
